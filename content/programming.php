...
<article id="cos">
	<h3>Cosine OS (COS)</h3>
	<section class="progbasis">
		<h4>Project Summary</h4>
		<div class="contentcontainer">
			<div class="screenie">
				<a href="https://github.com/NateDogg1232/cos"></a>
			</div>
			<div class="writing">
	...
	<section class="tools">
		...
		<div class="content">
			<p>I have cycled through many tools while writing this OS, and have gathered many skills in using each one of these tools.</p>
			<ul>
				<li>Atom - Used to write code</li>
				<li>Bochs - Used to test the OS</li>
				<li>GNU C Compiler and GNU Binutils - Used to compile and link the OS</li>
				<li>QEMU - Again, used to test the OS</li>
				<li>Oracle VM VirtualBox - To test the OS</li>
				<li>Vagrant - To aid in compiling on Windows</li>
				<li>Git - To keep and track the code</li>
			</ul>
		</div>
	</section>
</article>
<article id="amurtiger">
	<h3>Endangered Species Website</h3>
	<section class="progbasis">
		<h4>Project Summary</h4>
		<div class="contentcontainer">
			<div class="screenie">
	...
	<section class="tools">
		...
		<div class="content">
			<p>With this website, we have used many industry-standard tools</p>
			<ul>
				<li>Brackets - To write the code</li>
				<li>Photoshop - To make mock-ups</li>
				<li>Many different web browsers - To test the site</li>
				<li>Google Chome - We used this one to debug</li>
			</ul>
		</div>

	</section>
</article>
<article id="digital-ethics">
	<h3>Digital Ethics Website</h3>
	<section class="progbasis">
		<h4>Project Summary</h4>
		<div class="contentcontainer">
			<div class="screenie">
	...
	<section class="tools">
		...
		<div class="content">
			<p>This website used many of the same tools as the Endangered Species Website</p>
			<ul>
				<li>Brackets - To write the code</li>
				<li>Photoshop - To make moodboards</li>
				<li>Google Chome - To test the website</li>
				<li>Git - To store code, track code editing, and merge branches</li>
			</ul>
		</div>
	</section>
</article>
<article id="t6aip">
	<h3>The 6502 Assembler and Interpreter Project (T6AIP)</h3>
	<section class="progbasis">
		<h4>Project Summary</h4>
		<div class="contentcontainer">
			<div class="screenie">
	...
	<section class="tools">
		...
		<div class="content">
			<p>Due to the limited nature of the hardware and the unpopularity of the platform, there are not many tools to be used.</p>
			<ul>
				<li>SmileBASIC - To write and test the code</li>
				<li>Git - To store the code and documentation</li>
				<li>The <a class="darker" href="http://smilebasicsource.com/forum?ftid=468">SmileBASIC File Manager</a> - To export the files to upload to GitHub</li>
			</ul>
		</div>
	</section>
</article>
